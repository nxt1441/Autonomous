...
# ── Occupancy grid ───────────────────────────────────────────────────────────
MAP_SIZE        = 400               # cells (covers ~10 m × 10 m)
...
DEPTH_OBSTACLE_SUPPORT_MAX_HEIGHT = 0.04
DEPTH_OBSTACLE_SUPPORT_FORWARD_TOLERANCE = 0.12
DEPTH_OBSTACLE_SUPPORT_LATERAL_TOLERANCE = 0.12
DEPTH_OBSTACLE_FLOATING_MIN_HEIGHT = 0.05
DEPTH_OBSTACLE_FLOATING_MAX_HEIGHT = 0.45
DEPTH_OBSTACLE_LOG_ODDS_INCREMENT = 2.0
...
DEPTH_OBSTACLE_BRIDGE_GAP_CELLS = 3
DEPTH_OBSTACLE_FRONT_WIDTH = 0.38
DEPTH_OBSTACLE_STOP_DISTANCE = 0.35
DEPTH_FLOOR_PLANE_MIN_HEIGHT = 0.035
DEPTH_FLOOR_PLANE_MAX_HEIGHT = 0.24
DEPTH_FLOOR_PLANE_MIN_CELLS = 4
DEPTH_FLOOR_PLANE_LIDAR_CLEAR_RADIUS = 3
DEPTH_FLOOR_PLANE_CLOSE_KERNEL = 3
DEPTH_FLOOR_PLANE_MIN_COMPONENT_CELLS = 4
DEPTH_FLOOR_PLANE_MIN_MINOR_SPAN = 1
DEPTH_FLOOR_PLANE_MAX_ASPECT_RATIO = 30.0
DEPTH_FLOOR_PLANE_VERTICAL_REJECT_HEIGHT = 0.30
DEPTH_FLOOR_PLANE_VERTICAL_REJECT_PIXELS = 3
DEPTH_FLOOR_PLANE_SURFACE_DEPTH_TOLERANCE = 0.12
DEPTH_FLOOR_PLANE_CONFIRMATION_COUNT = 2
DEPTH_FLOOR_PLANE_CONFIRM_NEAR_EXISTING_RADIUS = 2
DEPTH_FLOOR_PLANE_IMMEDIATE_CELLS = 12
